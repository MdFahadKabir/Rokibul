      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-16 right-0 bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-3 w-auto"
          >
            <div className="flex flex- gap-2">
              {/* <p className="text-sm font-medium mb-1 px-2">
                {t("theme.title")}
              </p> */}
              ...
              {["light", "dark"].map(
                (themeOption) => (
                  <motion.button
                    ...
                    className={`flex items-center gap-3 px- py-2 rounded-md text-left 
